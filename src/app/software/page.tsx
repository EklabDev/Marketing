      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-500">
            We create custom software solutions tailored to your business needs. Our team of experienced developers
            specializes in building scalable, secure, and user-friendly applications.
          </p>
        </div>
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <form onSubmit={handleSubmit} className="mt-5 space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  {submitStatus === 'error' && (
                    <p className="text-sm text-red-600">Error submitting form. Please try again.</p>
                  )}
                </div>
              </form>
            </div>
