    ...
    <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-12 max-w-none text-gray-600">
          <p className="mb-4">
            Welcome to EKLab. By accessing our website and using our services, you agree to be bound by these Terms of Service.
          </p>

          <h3 className="text-teal-600 font-semibold mt-8 mb-4 text-xl">1. Acceptance of Terms</h3>
          <p className="mb-4">
            By accessing or using any part of our website or services, you agree to be bound by these Terms of Service.
          ...
          <h3 className="text-teal-600 font-semibold mt-8 mb-4 text-xl">6. Governing Law</h3>
          <p className="mb-4">
