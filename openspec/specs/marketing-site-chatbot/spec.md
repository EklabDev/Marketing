...
Embedded assistant on the EKLab marketing site, backed by the Vector Client invoke API, with client session handling, frontend rate limiting, and server-side proxy configuration.
